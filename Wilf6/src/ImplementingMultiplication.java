...
public class ImplementingMultiplication {
    ...
    public static void main(String[] args){
        ...
        */
        ...
        long[] values = upperRecursionWrapper(MAX);
    ...
    public static long[] upperRecursionWrapper(int distanceLeft){
        return new long[1];
        //return add(middleRecursionWrapper(distanceLeft, 1), upperRecursion(distanceLeft, 0));
    }
/*
    ...
    public static long[] middleRecursionWrapper(int distanceLeft, int cutoff){
        if (cutoff <= cutoffs.length - 1){
            return add(middleRecursionWrapper(distanceLeft, cutoff + 1), middleRecursion(distanceLeft, 0, cutoff));
        } else {
